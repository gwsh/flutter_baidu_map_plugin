 ...
 */
public class FlutterBaiduMapPlugin implements FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {

    // 通道名称
    private static final String CHANNEL_METHOD_LOCATION = "flutter_baidu_plugin_gwsh";
    private static final String CHANNEL_STREAM_LOCATION = "flutter_baidu_plugin_gwsh_stream";
    ...
    public static void registerWith(Registrar registrar) {
        ...
        FlutterBaiduMapPlugin plugin = new FlutterBaiduMapPlugin();
